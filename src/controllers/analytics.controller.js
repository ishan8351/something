...
export const getDashboardAnalytics = asyncHandler(async (req, res) => {
    ...
    const revenueTrend = await Order.aggregate([
        ...
        {
            $group: {
                // Using %Y-%m-%d is safer for consistent JS parsing
    ...
    // --- CHART DATA FIX: Fill in the missing days with zeroes ---
    ...
    for (let i = 29; i >= 0; i--) {
        ...
        // Format for the frontend chart (e.g., "Oct 15")
    ...
    return res.status(200).json(
        new ApiResponse(
            200,
            {
                ...
                revenueTrend: completeRevenueTrend, // Using the fixed complete array!
