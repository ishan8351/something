                                    ...
                                    <div className="flex flex-col gap-4">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full rounded-xl border border-slate-200 bg-white p-3 font-bold text-slate-900 transition-all outline-none focus:border-slate-900 focus:ring-1 focus:ring-slate-900"
                                            >
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full rounded-xl border border-slate-200 bg-white p-3 font-medium text-slate-900 transition-all outline-none focus:border-slate-900 focus:ring-1 focus:ring-slate-900"
                                                        />
                                                    </div>
                                                    <div>
                                                        <label className="mb-1 block text-xs font-bold tracking-wider text-slate-600">
                                            ...
                                            {editForm.status === 'NDR' && (
                                                ...
                                                >
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full rounded-xl border border-amber-200 bg-amber-50 p-3 font-bold text-amber-900 transition-all outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
                                                    />
                                                </motion.div>
                                            )}
                                        </AnimatePresence>
