                                    ...
                                    <div className="flex-1">
                                        <div className="mb-3 flex flex-wrap items-center gap-3">
                                            ...
                                            {ord.tracking?.courierName && (
                                                <span className="flex items-center gap-1.5 rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-[10px] font-extrabold tracking-widest text-slate-500 uppercase">
                                                    <Truck size={12} /> {ord.tracking.courierName}
                                                </span>
                                            )}
                                        </div>
